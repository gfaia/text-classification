...
import helper
from recurrent_nn_model import RecurrentNN
...
def main(unused_argv):
  ...
  model = RecurrentNN(
    ...
    vocab_size=vocab_size, rnn_size=FLAGS.rnn_size, num_layers=FLAGS.num_layers, 
    decay_steps=FLAGS.decay_steps, decay_rate=FLAGS.decay_rate, seq_len=FLAGS.seq_len, 
