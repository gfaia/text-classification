...
import helper
from capsule_net_model import CapsuleNet
...
def main(unused_argv):
  ...
  model = CapsuleNet(
    ...
    num_capsule=FLAGS.num_capsule, dim_capsule=FLAGS.dim_capsule,
...
if __name__ == "__main__":
  ...
  parser.add_argument('--num_capsule', type=int, default=50, 
                      help='The number of capsule.')
  parser.add_argument('--dim_capsule', type=int, default=100, 
                      help='The dimension of capsule.')
