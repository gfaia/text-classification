...
def main(unused_argv):
  ...
  for i in range(FLAGS.max_steps):
    ...
    xs, ys = helper.generate_batch(data=x_train, labels=y_train, batch_size=FLAGS.batch_size)
    _, _ = sess.run([model.optimization, model.add_global], 
                    feed_dict={ model.inputs: xs, model.labels: ys, 
